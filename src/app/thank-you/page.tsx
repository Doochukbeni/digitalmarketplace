    ...
    <main className="relative lg:min-h-full">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24  lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
        <div className="lg:col-start-2">
          <p className="font-medium text-sm text-blue-600 tracking-tight">
            Order successful
          </p>
          ...
          {order._isPaid ? (
            ...
            <p className="mt-2 text-base text-muted-foreground ">
              We appreciate your order and we&apos;re currently processing it at
              the moment, so hang in tight and we&apos;ll send you confirmation
              as soon as possible
            </p>
          )}
          <div className="mt-16 text-sm font-medium flex items-center gap-2">
                ...
                <li key={product.id} className="flex space-x-6 py-6 ">
                  ...
                  <div className="flex-auto flex flex-col justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="space-y-1">Category : {label} </p>
                    </div>
          ...
          <div className="space-y-6 border-t border-gray-200 pt-6 text-sm text-muted-foreground font-medium">
            <div className="flex justify-between">
              <p>subtotal</p>
              <p className="text-slate-900">{formatPrice(orderTotal)}</p>
            </div>
            <div className="flex justify-between">
              <p>Transaction fee</p>
            ...
            <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-slate-900">
